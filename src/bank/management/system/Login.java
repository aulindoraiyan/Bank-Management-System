...
public class Login extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
     ...
     //query te first mentioned cardnumber will be fetvh the column from SQL and the second card number is equal to jeta input deya hoise
     // same for the pin  number. 
