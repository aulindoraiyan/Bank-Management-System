...
import javax.swing.*;
import java.awt.*;  // this is font class
...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        this.formno = formno;
        setLayout(null); // jottokhon set layout null na kori nicher code wont work
        ...
        type.setBounds(100, 110, 250, 30);
        add(type);
        
        r1 = new JRadioButton("Saving Account");
        r1.setFont(new Font("Raleway", Font.BOLD, 16));
        r1.setBackground(Color.WHITE);
        r1.setBounds(100, 150, 220, 20);
        add(r1);
        ...
        card.setBounds(100, 270, 250, 30);
        add(card);
        
         JLabel number = new JLabel("XXX-XXX");
        number.setFont(new Font("Raleway", Font.BOLD, 22));
        number.setBounds(330, 270, 300, 30);
        add(number);
        
        JLabel carddetail = new JLabel("Your 6 digit card number");
    ...
    if(ae.getSource() == submit){
        ...
        String cardnumber = "" + random.nextInt(100000, 909999) ;
